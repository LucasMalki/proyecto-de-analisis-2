...
<div class="container">
    ...
    <form method="post">
        ...
        <div class="mb-3">
            ...
            <input type="password" name="contraseña" class="form-control" id="direccion" placeholder="Escribe una contraseña">
        </div>
...
if(isset($_POST['registrar'])){
    ...
    $resultado = registrarUsuario($usuario, $nombre, $telefono, $direccion, $contraseña);
    if($resultado){
        echo'
