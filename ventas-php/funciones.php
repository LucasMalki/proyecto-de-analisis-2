...
function registrarUsuario($usuario, $nombre, $telefono, $direccion, $contraseña){
...
function registrarProveedor( $nombre, $telefono, $direccion, $producto){
    $sentencia = "INSERT INTO proveedor (nombre, telefono, direccion, producto) VALUES (?,?,?,?,?)";
    $parametros = [ $nombre, $telefono, $direccion, $producto];
    return insertar($sentencia, $parametros);
}
function realizarPedido( $nombre, $cantidad, $marca,){
    $sentencia = "INSERT INTO pedido (nombre, cantidad, marca) VALUES (?,?,?,?,?)";
    $parametros = [ $nombre, $cantidad, $marca];
    return insertar($sentencia, $parametros);
}
